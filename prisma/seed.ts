...
async function main() {
  ...
  await prisma.fact.createMany({
    data: [
      ...
      { threadId: nimbus.id, section: "companySnapshot", content: "Founded 2016, HQ Austin, TX.", sourceType: "RESEARCHED", sourceDetail: "nimbusrobotics.example" },
      { threadId: nimbus.id, section: "companySnapshot", content: "~600 employees.", sourceType: "RESEARCHED", sourceDetail: "nimbusrobotics.example" },
      ...
      { threadId: nimbus.id, section: "companyAtLocation", content: "Local office opened 2019, ~120 engineers.", sourceType: "RESEARCHED", sourceDetail: "glassdoor.com" },
      { threadId: nimbus.id, section: "companyAtLocation", content: "Reports to the central platform engineering org.", sourceType: "RESEARCHED", sourceDetail: "glassdoor.com" },
      ...
      { threadId: nimbus.id, section: "roleSpecifics", content: "Team of 6 engineers, hybrid 3 days/week.", sourceType: "RESEARCHED", sourceDetail: "glassdoor.com" },
      { threadId: nimbus.id, section: "roleSpecifics", content: "Owns fleet telemetry and deployment infrastructure.", sourceType: "RESEARCHED", sourceDetail: "glassdoor.com" },
